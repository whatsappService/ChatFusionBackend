...
**Description:** Get all WhatsApp accounts for the authenticated user.
...
**How it works:**
1. Gets API key from user's business
2. Calls ChatFusion service at `https://be.muraasala.com/api/accounts` with X-API-Key header
3. Returns list of all WhatsApp accounts associated with the API key
4. Each account includes ID, name, phone number, status, and connection timestamps
